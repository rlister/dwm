...
static const char *fonts[]          = { "Terminus:style=Regular:size=12" };
static const char dmenufont[]       = "Terminus:style=Regular:size=12";
...
static const Rule rules[] = {
	...
	/* { NULL,       NULL,       "Zoom Cloud Meetings",       1 << 8,       0,           -1 }, */
...
static Key keys[] = {
  ...
  /* rotatetags patch */
	{ MODKEY,                       XK_comma,  rotatetags,     {.i = -1 } },
	{ MODKEY,                       XK_period, rotatetags,     {.i = +1 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
